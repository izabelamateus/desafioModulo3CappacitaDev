...
function curarPokemon(id){
    ...
    if(pokemon.hp < 100){
        ...
        return `Seu ${pokemon.nome} estava com ${pokemon.hp - 20} hp e agora está com ${pokemon.hp<=100? pokemon.hp : 100 } hp!`
    }
    if(pokemon.hp >=100){
        pokemon.hp = 100
        return `Seu ${pokemon.nome} já está com a quantidade máxima de hp (100)!`
    }
